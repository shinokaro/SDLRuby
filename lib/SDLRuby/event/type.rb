module SDLRuby
  class Event
    module Type
      ...
      EDIT_EVENT = SDL_TEXTEDITING
      TEXT_EVENT = SDL_TEXTINPUT
      EDIT_EXT_EVENT = SDL_TEXTEDITING_EXT
      MOTION_EVENT = SDL_MOUSEMOTION
      BUTTON_EVENT = SDL_MOUSEBUTTONDOWN..SDL_MOUSEBUTTONUP
      WHEEL_EVENT = SDL_MOUSEWHEEL
      JAXIS_EVENT = SDL_JOYAXISMOTION
      JBALL_EVENT = SDL_JOYBALLMOTION
      JHAT_EVENT = SDL_JOYHATMOTION
      JBUTTON_EVENT = SDL_JOYBUTTONDOWN..SDL_JOYBUTTONUP
      JDEVICE_EVENT = SDL_JOYDEVICEADDED..SDL_JOYDEVICEREMOVED
      JBATTERY_EVENT = SDL_JOYBATTERYUPDATED
      CAXIS_EVENT = SDL_CONTROLLERAXISMOTION
